...
export function listaPrestamos() {
     ...
     tr.innerHTML = "<tr><th>id</th></tr><tr><th>titulo</th></tr><tr><th>autor</th></tr><tr><th>editorial</th></tr><tr><th>tema</th></tr><tr><th>prestado</th></tr>";
     tabla.appendChild(tr);
 
     arrayPrestamos.forEach(element => {
         let trw = document.createElement('tr');
         trw.innerHTML = `<tr><td>${element.id}</td></tr><tr><td>${element.titulo}</td></tr><tr><td>${element.autor}</td></tr><tr><td>${element.editorial}</td></tr><tr><td>${element.tema}</td></tr><tr><td>${element.prestado}</td></tr>`;
...
export function listaSocios() {
    ...
    let tabla = document.createElement('table');
    let tr = document.createElement('tr');
    tr.innerHTML = "<tr><th>idSocio</th></tr><tr><th>nombre</th></tr><tr><th>mail</th></tr>";
    tabla.appendChild(tr);

    arraySocios.forEach(element => {
        let trw = document.createElement('tr');
        trw.innerHTML = `<tr><td>${element.idSocio}</td></tr><tr><td>${element.nombre}</td></tr><tr><td>${element.mail}</td></tr>`;
        tabla.appendChild(trw);
    });
